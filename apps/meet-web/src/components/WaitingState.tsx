      ...
      >
        ...
        >
          <motion.div
            ...
            className="w-28 h-28 rounded-full bg-[var(--ts-bg-dark)] flex items-center justify-center"
          >
            <Users className="w-12 h-12 text-[var(--ts-teal)]" />
          </motion.div>
        </motion.div>
        ...
        <motion.h2
          ...
          className="text-[var(--ts-teal)] mb-2"
        >
          Waiting for others to join...
        </motion.h2>
        <p className="text-[var(--ts-text-secondary)]">
