...
public class OrganizationEntity {
    ...
    @Column(name="logo_asset_id") private String logoAssetId;
    ...
    public String getLogoAssetId(){return logoAssetId;} public void setLogoAssetId(String l){this.logoAssetId=l;}
}