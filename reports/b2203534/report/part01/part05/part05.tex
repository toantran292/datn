...
\begin{itemize}
    ...
    \item Khảo sát và phân tích một số nền tảng và công cụ tiêu biểu như Jira, Notion, Slack, Microsoft Teams, Base.vn,… để rút ra ưu điểm, hạn chế và xác định khoảng trống về một lớp nền tảng và thông tin thống nhất.

    \item Xác định yêu cầu và mục tiêu cho phân hệ nền tảng và thông tin: quản lý tài khoản, workspace, phân quyền, lưu trữ tệp dùng chung, quản lý thông báo tập trung và xây dựng AI Service đóng vai trò điều phối, tổng hợp thông tin từ các phân hệ chức năng.
