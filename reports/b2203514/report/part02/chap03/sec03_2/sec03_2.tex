...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{images/user_groups.png}
...
\begin{itemize}
    ...
    \item \textbf{Complementary:} PostgreSQL làm "source of truth", Redis làm performance op\-ti\-mi\-za\-tion và real-time coordination.
\end{itemize}
