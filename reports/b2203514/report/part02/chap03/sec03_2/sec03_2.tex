...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{images/layered_architecture.png}
\caption{Kiến trúc phân lớp trong NestJS Service}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{images/func_channel_admin.png}
