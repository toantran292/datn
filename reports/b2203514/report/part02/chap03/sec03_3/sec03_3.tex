...
\begin{itemize}
    ...
    \item ai\_features: Cấu hình các tính năng AI được phép (JSONB): summarization, ac\-tion\_i\-tems, qa, document\_summary.
...
\begin{itemize}
    ...
    \item source\_references: Tham chiếu nguồn (JSONB): message\_id, chunk\_id, re\-le\-van\-ce\_\-sco\-re.
