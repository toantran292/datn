...
\begin{itemize}
    ...
    \item Thuộc tính \texttt{mes\-sage\_type} phải có một trong các giá trị: TEXT, SYSTEM, AI\_RESPONSE.
...
\begin{itemize}
    ...
    \item Thuộc tính \texttt{pro\-ces\-sing\_status} phải có một trong các giá trị: PENDING, PROCESSING, COM\-PLETED, FAILED.
\end{itemize}
...
\begin{itemize}
    ...
    \item Thuộc tính \texttt{tokens\_used} phải là số nguyên dương (prompt\_tokens + com\-ple\-tion\_tokens).
