...
Trong đề tài này, hệ thống quản lý dự án được xây dựng hoàn toàn theo mô hình SaaS với kiến trúc Multi-tenant, trong đó mỗi organization đại diện cho một tenant độc lập với dữ liệu (projects, sprints, issues, custom statuses) được phân tách hoàn toàn ở cấp database và logic. Người dùng truy cập hệ thống thông qua trình duyệt web mà không cần cài đặt bất kỳ phần mềm nào, đảm bảo trải nghiệm nhất quán trên mọi thiết bị và nền tảng. Hệ thống được thiết kế theo nguyên lý API-first, cung cấp RESTful API để tích hợp với các dịch vụ bên ngoài như LLM Provider (OpenAI, Anthropic Claude) cho các tính năng AI Sprint Summary, AI Issue Description Generation và AI Task Breakdown, cũng như Cloud Storage (MinIO/S3) cho issue attachments. Kiến trúc Microservices với PM Service (NestJS + Prisma) kết hợp containerization (Docker) cho phép mở rộng horizontal khi số lượng projects, sprints và issues tăng lên, đáp ứng yêu cầu về tính sẵn sàng cao và khả năng chịu tải của một nền tảng SaaS quản lý dự án chuyên nghiệp.
