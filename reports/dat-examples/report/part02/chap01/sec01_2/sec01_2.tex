...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\textwidth]{images/usecase_project_lead.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\textwidth]{images/usecase_team_member.png}
        \caption{Sơ đồ trường hợp sử dụng của Team Member}
        \label{fig:usecase_team_member}
    \end{figure}

    \item \textbf{Sơ đồ trường hợp sử dụng của Viewer/Stakeholder:} Viewer hoặc Stakeholder là tác nhân có quyền chỉ đọc (read-only) đối với dự án, thường là khách hàng, nhà đầu tư, quản lý cấp cao hoặc các bên liên quan cần theo dõi tiến độ dự án nhưng không tham gia trực tiếp vào quá trình thực hiện. Các chức năng chính của Viewer/Stakeholder bao gồm: xem tổng quan dự án (xem thông tin cơ bản của dự án như tên, mô tả, project lead, timeline, không có quyền chỉnh sửa cấu hình), xem board view (xem bảng Kanban với các cột status và issue cards, xem trạng thái hiện tại của các công việc, không có quyền kéo thả hoặc thay đổi bất kỳ thông tin nào), xem backlog (xem danh sách sprint và các issue trong backlog, xem phân bổ công việc cho từng sprint, không có quyền di chuyển issue giữa các sprint), xem chi tiết issue (xem đầy đủ thông tin của issue bao gồm type, priority, status, assignees, story points, mô tả, không có quyền tạo, chỉnh sửa hoặc xóa issue), xem sprint (xem danh sách các sprint với trạng thái FUTURE/ACTIVE/CLOSED, xem sprint goal và timeline, xem tổng quan số lượng issue theo trạng thái trong sprint, không có quyền tạo, bắt đầu hoặc hoàn thành sprint), xem comments (xem toàn bộ comments của các issue để hiểu ngữ cảnh và thảo luận, không có quyền thêm, chỉnh sửa hoặc xóa comment), xem activity log (theo dõi lịch sử thay đổi và hoạt động của dự án theo thời gian thực, xem ai đã làm gì và khi nào), xem analytics và báo cáo (xem các biểu đồ thống kê như Created vs Resolved, phân bố issue theo type/priority/status, xem báo cáo sprint summary được tạo bởi AI, không có quyền cấu hình hoặc xuất báo cáo tùy chỉnh), và xem timeline/calendar (xem lịch trình công việc và các milestone của dự án, xem deadline và ngày hoàn thành mục tiêu).

    \begin{figure}[H]
        \centering
        \includegraphics[width=\textwidth]{images/usecase_viewer.png}
