...
\textbf{UC06.2 - Tự động tạo mô tả công việc}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/uc06_2_ai_description.png}
    \caption{Sơ đồ use case chức năng tự động tạo mô tả công việc}
    \label{fig:uc06_2_ai_description}
\end{figure}

\begin{longtblr}[
    caption = {Đặc tả use case UC06.2 - Tự động tạo mô tả công việc},
    label = {tab:uc06_2},
]{
    colspec={|l|p{.7\linewidth}|}
}
\hline
\textbf{Tên chức năng} & \textbf{Tự động tạo mô tả công việc} \\\hline
ID & UC06.2 \\\hline
