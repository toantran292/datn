...
% TODO: Thêm ảnh ui_issue_detail.png
% \begin{figure}[H]
% \centering
...
\textbf{Giao diện quản lý Project Members:}

Giao diện quản lý Project Members hiển thị danh sách tất cả thành viên trong project với thông tin: họ tên, email, vai trò (Project Lead/Team Member/Viewer), số issues assigned, và ngày tham gia. Project Lead có thể thêm members từ organization, thay đổi roles, và remove members.

% TODO: Thêm ảnh ui_project_members.png
% \begin{figure}[H]
% \centering
% \includegraphics[width=0.55\textwidth]{images/ui_project_members.png}
% \caption{Giao diện phác thảo quản lý Project Members}
% \label{fig:ui_project_members}
% \end{figure}

\textbf{Giao diện Sprint Management:}

Giao diện Sprint Management hiển thị danh sách tất cả sprints trong project với các tabs: ACTIVE (max 1), FUTURE, CLOSED. Mỗi sprint card hiển thị: sprint name, goal, date range, số issues (completed/total), progress bar, và actions. FUTURE sprints có action "Start Sprint" với validation. ACTIVE sprint có action "Complete Sprint" trigger AI Summary generation. CLOSED sprints hiển thị AI-generated summary preview và link "View Full Summary".

% TODO: Thêm ảnh ui_sprints.png
% \begin{figure}[H]
% \centering
% \includegraphics[width=0.65\textwidth]{images/ui_sprints.png}
% \caption{Giao diện phác thảo Sprint Management}
% \label{fig:ui_sprints}
% \end{figure}

\textbf{Giao diện Sprint Summary (AI-generated):}
...
% TODO: Thêm ảnh ui_sprint_summary.png
% \begin{figure}[H]
% \centering
...
% TODO: Thêm ảnh ui_complete_sprint.png
% \begin{figure}[H]
% \centering
...
\textbf{Giao diện Activity Feed:}

Giao diện Activity Feed hiển thị timeline của tất cả activities trong project: issue created, status changed, sprint started, comment added, issue assigned, sprint completed, etc. Mỗi activity entry hiển thị: user avatar, action type, entity affected (issue key, sprint name), changes (before/after values), và timestamp. Filters cho phép lọc theo action type, user, date range.

% TODO: Thêm ảnh ui_activity.png
% \begin{figure}[H]
% \centering
% \includegraphics[width=0.55\textwidth]{images/ui_activity.png}
% \caption{Giao diện phác thảo Activity Feed}
% \label{fig:ui_activity}
% \end{figure}
...
% TODO: Thêm ảnh ui_custom_statuses.png
% \begin{figure}[H]
% \centering
...
\textbf{Giao diện Project Settings:}

Giao diện Project Settings cho phép Project Lead cấu hình project: thông tin cơ bản (name, key, description, avatar), default assignee, Board/Backlog config (column ordering, filters), AI settings (preferred LLM provider, custom prompts cho Sprint Summary và Task Breakdown), và archive project option.

% TODO: Thêm ảnh ui_project_settings.png
% \begin{figure}[H]
% \centering
% \includegraphics[width=0.5\textwidth]{images/ui_project_settings.png}
% \caption{Giao diện phác thảo Project Settings}
% \label{fig:ui_project_settings}
% \end{figure}
...
\textbf{Giao diện Organization Dashboard:}

Giao diện Organization Dashboard (dành cho Organization Owner) hiển thị tổng quan về organization: số projects, total members, storage usage, AI tokens consumed. Charts hiển thị: project creation trend, sprint velocity across projects, issue completion rates. Actions: "Create Project", "Manage Members", "Organization Settings". Danh sách recent activities across all projects trong organization.

% TODO: Thêm ảnh ui_org_dashboard.png
% \begin{figure}[H]
% \centering
% \includegraphics[width=0.65\textwidth]{images/ui_org_dashboard.png}
% \caption{Giao diện phác thảo Organization Dashboard}
% \label{fig:ui_org_dashboard}
% \end{figure}
