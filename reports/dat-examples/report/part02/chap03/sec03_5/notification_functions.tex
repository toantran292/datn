...
\textbf{Mục đích:} Hệ thống tự động ghi lại activities khi có actions xảy ra trong project với before/after changes tracking.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{images/act_log_activity.png}
