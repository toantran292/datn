...
\begin{itemize}
    ...
    \item Tích hợp trí tuệ nhân tạo vào hệ thống quản lý dự án thông qua việc kết nối với Large Language Model API (OpenAI GPT hoặc Claude API), xây dựng các chức năng AI hỗ trợ cải thiện và hoàn thiện mô tả issue tự động, đề xuất acceptance criteria và kiểm tra tính đầy đủ thông tin; phát triển tính năng ước lượng story points thông minh dựa trên phân tích nội dung issue và học từ dữ liệu lịch sử; tạo tóm tắt sprint tự động khi hoàn thành bao gồm achievements, metrics và release notes.

    \item Nghiên cứu và áp dụng kỹ thuật prompt engineering để tối ưu hóa chất lượng đầu ra từ các mô hình ngôn ngữ lớn, thiết kế prompt templates phù hợp cho từng tính năng AI (issue enhancement, story point estimation, sprint summary), xử lý và format dữ liệu đầu vào/đầu ra, xây dựng cơ chế fallback và error handling cho các API call, đảm bảo trải nghiệm người dùng mượt mà ngay cả khi AI service gặp sự cố.
\end{itemize}
...
\begin{itemize}
    ...
    \item Tích hợp các tính năng trí tuệ nhân tạo vào quy trình làm việc để nâng cao năng suất và chất lượng quản lý dự án: (1) AI Issue Enhancement giúp tự động cải thiện mô tả công việc, đề xuất acceptance criteria và kiểm tra tính đầy đủ thông tin khi tạo issue mới; (2) Smart Story Point Estimation phân tích nội dung issue và đề xuất story points dựa trên dữ liệu lịch sử các issue tương tự, giúp team ước lượng chính xác hơn; (3) Sprint Summary tự động tạo báo cáo tổng kết sprint khi hoàn thành, bao gồm các achievements chính, metrics và release notes, giúp tiết kiệm thời gian viết báo cáo và documentation.
