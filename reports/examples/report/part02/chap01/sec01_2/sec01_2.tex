...
\begin{itemize}
    \item \textbf{Sơ đồ trường hợp sử dụng tổng quan:} Sơ đồ này mô tả toàn bộ các chức năng chính của hệ thống và mối quan hệ giữa các tác nhân với hệ thống. Hệ thống phân hệ nền tảng và thông tin cung cấp các nhóm chức năng chính bao gồm: quản lý tài khoản và xác thực, quản lý workspace, quản lý thành viên và phân quyền, quản lý file, quản lý thông báo, tích hợp AI và cung cấp giao diện quản trị. Mỗi tác nhân có quyền truy cập vào các chức năng tương ứng với vai trò của mình trong hệ thống.
